class Event::Scoreboard::Standings
  attr_reader :competitors, :result_records, :rounds, :wind_cancellation

  def initialize(competitors, rounds, result_records, wind_cancellation: false)
