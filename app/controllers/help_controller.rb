# Mostly taken from GitLabHQ/GitLabHQ
# Gitlab code available under an MIT license.
  ...
  def show
    ...
    respond_to do |format|
      format.any(:markdown, :md, :html) do
        path = Rails.root.join('doc', @category, "#{@file}.#{@locale}.md")
        ...
        if File.exist?(path)
          ...
          render 'errors/not_found.html.haml', status: 404
        end
      end
