class PerformanceCompetitions::TrackUploadsController < ApplicationController
  ...
  def matched_competitors
    ...
    return PerformanceCompetition::Competitor.none if number.blank?
  ...
  def render_feedback(messages)
    render turbo_stream: turbo_stream.update(
      ...
      partial: 'performance_competitions/track_uploads/feedback',
      locals: { messages: }
