class Api::V1::Events::Rounds::ReferencePointAssignmentsController < ApplicationController
  include PerformanceCompetitionScoped

  before_action :set_event, :authorize_event_update!, :set_round
  ...
  def create
    ...
    perform_action =
      if reference_point_id
        proc { assignment.update(reference_point_id:) }
      else
