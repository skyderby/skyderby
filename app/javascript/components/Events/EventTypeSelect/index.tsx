      ...
      <div className={styles.container}>
        ...
        <Link to="/events/performance/new" className={styles.card}>
          ...
          <p className={styles.details}>
            The objective is to fly a single wingsuit in three separate tasks to
            demonstrate a combination of best time, distance and speed.
            <br />
        ...
        <Link to="/events/speed_skydiving/new" className={styles.card}>
          ...
          <p className={styles.details}>
            ...
            <br />
            FAI rules compliant, but NOT yet approved to be used for first category
            events.
          </p>
        </Link>
